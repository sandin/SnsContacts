package com.lds.snscontacts.widget;
 ...
 * android:name="android.permission.SYSTEM_ALERT_WINDOW"/><!--系统弹出窗口权限-->权限不然会报错
 */
...
public class FloatingWindow {
    ...
    private static int objHeight;

    private static int objWidth;
    ...
    public static void show(Context context, Window window, View floatingViewObj) {
        ...
        FloatingWindow.floatingViewObj = floatingViewObj;
    ...
    public static boolean onTouchEvent(MotionEvent event, View view) {
        width = view_obj.getMeasuredWidth();
        height = view_obj.getMeasuredHeight();
    ...
    private static void updateViewPosition(View view) {
        ...
        params.x = (int) (x - mTouchStartX - width/2);

        params.y = (int) (y - mTouchStartY - height);

        wm.updateViewLayout(FloatingWindow.floatingViewObj, params);
